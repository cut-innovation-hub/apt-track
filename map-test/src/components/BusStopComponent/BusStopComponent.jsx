...
import { createRoutesString, getWalikingRoadCoordinates, getWalkingLength } from "../../utils/mapbox-functions";

function BusStopComponent({ name, coords, picture }) {
  ...
  return (
    ...
    >
      <div className="w-1/5 h-14 rounded">
        <img src={ picture ? picture : busstop_icon} className="object-cover rounded h-14 w-full" alt="bus stop icon" />
      </div>
