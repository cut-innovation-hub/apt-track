...
const AddRouteDrawer = () => {
  ...
  const [route_coords, setRouteCoords] = useState([]);
  const [routes_string, setRouteString] = useState();
  const [markers_set, setMarkersSet] = useState(null);
  const [road_coords, setRoadCoords] = useState(null);
