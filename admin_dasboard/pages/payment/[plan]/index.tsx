...
import {
  BadgeCheckIcon,
  BookmarkIcon,
  CreditCardIcon as SolidCreditCardc,
...
import visa_logo from "../../../public/svgs/visa.svg";
import mastercard_logo from "../../../public/svgs/mastercard.svg";
...
function Payment({}: Props) {
  ...
  // field inputs
  const [card_number, setCardNumber] = useState<any>(0);
  const [typeDetected, setTypeDetected] = useState<any>(false);
  ...
  return (
    <div className="flex flex-row items-center w-full flex-1 mx-auto max-w-7xl px-2 py-32">
      <div className="flex md:flex-row flex-col w-full md:space-x-24">
        <div className="md:w-2/3 w-full flex flex-col space-y-8">
          <div className="flex flex-row items-center w-full justify-between">
            <p className="text-gray-700 font-semibold">Apttrack</p>
          ...
          <div className="flex flex-col space-y-4 w-full items-start justify-between">
            <div className="flex flex-col">
              <p className="text-sm font-semibold text-gray-700">Card Number</p>
            ...
            <div className="flex flex-row space-x-4 w-full items-center p-3 border-2 border-gray-200 rounded-lg">
              <div className="flex">
                {typeDetected === "visa" || typeDetected === "mastercard" ? (
                  <div className="flex">
                    {typeDetected === "visa" ? (
                      <Image src={visa_logo} height={30} width={30} />
                    ) : (
                      <Image src={mastercard_logo} height={30} width={30} />
                    )}
                  </div>
                ) : (
                  <CreditCardIcon
              ...
              <span
                className={`${
                  card_number.length === 16 ? "text-blue-700" : "text-gray-300"
                } `}
              >
          ...
          <div className="flex md:flex-row flex-col justify-between">
            ...
            <div className="flex items-center p-3 border-2 rounded-lg border-gray-200">
          ...
          <div className="flex md:flex-row flex-col justify-between">
            ...
            <div className="flex flex-row items-center p-3 border-2 rounded-lg border-gray-200">
              ...
              <input
                ...
                className="outline-none border-none flex-1"
              />
              <CalendarIcon height={20} width={20} className="text-gray-500" />
            </div>
          </div>
          <div className="flex md:flex-row flex-col justify-between">
            <div className="flex flex-col">
        ...
        <div className="md:w-1/3 w-full flex flex-col md:mx-4 pt-16">
          <div className="bg-gray-100 rounded-xl p-8 relative pt-52">
            <div className="absolute bg-white shadow -top-16 rounded-xl mx-auto p-8 ml-auto mr-auto left-0 right-0 w-56">
              ...
              <div className="flex flex-row items-center justify-between">
                ...
                <div className="flex">
                  <WifiIcon height={20} width={20} className="text-gray-700" />
                </div>
              </div>
                ...
                <div className="flex flex-row items-center justify-between">
                  ...
                  <div className="flex">
                    ...
                    typeDetected === "mastercard" ? (
                      <div className="flex">
                        {typeDetected === "visa" ? (
                          <Image src={visa_logo} height={50} width={50} />
                        ) : (
                          <Image src={mastercard_logo} height={50} width={50} />
                        )}
                      </div>
                    ) : (
                      <CreditCardIcon
            ...
            <div className="flex flex-col w-full space-y-2">
              ...
              <div className="flex flex-row text-sm items-center justify-between">
                ...
                <p className="text-gray-700 font-semibold ">Premium Package</p>
              </div>
              <div className="flex flex-row text-sm items-center justify-between">
